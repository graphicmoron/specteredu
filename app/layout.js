...
})(window,document,'script','dataLayer','GTM-5QWXQ38W');`}
        </Script>
...
fbq('track', 'PageView');`}
      ...
      <body className="min-h-full flex flex-col">
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-5QWXQ38W"
            height="0"
            width="0"
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1043212645026019&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        <GSAPPlugins />
